...
public class WikiScrape {
	...
	public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
        ...
        System.out.println("parallel MPI Code");

        // Check # args.
        //sending number of articles as arguments
     //   if ( args.length > 1 ) { // min. args.length == 5 in mpiJava
       // System.out.println( "usage: " +
         //       "prunjava 1 MatrixMult matrix_size [y|n]" );
       // System.exit( -1 );
        }
       ...
       // int numberOfArticles = args[0];


        // To calculate the stripe size and start and end values for the partitions of all the ranks
       // int stripe = numberOfArticles / mpi_size;
       // int start = stripe * my_rank;
       // int end = stripe * (my_rank+1) - 1;
		
		
		//CHANGE ARTICLE NUMBER FROM THE EXCEL SHEET
	//	WikiScrape ws = new WikiScrape( stripe);
	//	ws.scrape();
	//	ws.writeGroundTruth();
